...
*/
    ...
    void downloadingSpeed(float speed){
        ...
        if (downloadSpeedcounter==30) {
            ...
            downSpeed.setText("Downloading Speed: " + downloadSpeed);
            resetSTT();
           // resetOurValue();
            stt.execute('U');
        }
    ...
    void uploadingSpeed(float speed){
        ...
        if (uploadingSpeedcounter==3){
            ...
            upSpeed.setText("Uploading Speed: " + uploadingspeed);

           // Toast.makeText(getApplicationContext(),"Uploading Speed: "+uploadingspeed,Toast.LENGTH_LONG).show();
            resetSTT();

            mydatabase.execSQL("INSERT INTO details VALUES('Internet','" + downloadSpeed + "','" + uploadingspeed + "');");
